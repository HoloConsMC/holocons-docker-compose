...
panel_compose := "pelican/panel/compose.yml"
wings_compose := "pelican/wings/compose.yml"
...
create-default-network:
    docker network create --driver bridge --subnet 172.20.0.0/16 default_nw
...
create-nginx-network:
    docker network create --driver bridge nginx_nw
